...
from target_mysql.target_mysql import TargetMySQL
from target_mysql.utils.error import SchemaUpdateError
...
class TestTargetMySQL:
    ...
    def test_record_missing_key_property(self, config, mysql_engine):
    ...
    def test_record_missing_required_property(self, config, mysql_engine):
    ...
    @pytest.mark.slow
    def test_camelcase(self, config, mysql_engine):
        ...
        self.integration_test(
            config, mysql_engine, expected_results, test_stream, drop_schema=False
        )
    ...
    @pytest.mark.slow
    def test_special_chars_in_attributes(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": None,
        ...
        self.integration_test(config, mysql_engine, expected_results, test_stream)

    @pytest.mark.slow
    def test_optional_attributes(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
    ...
    @pytest.mark.slow
    def test_schema_no_properties(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": None,
            "tables": [
    ...
    @pytest.mark.slow
    def test_schema_updates(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
    ...
    @pytest.mark.slow
    def test_multiple_state_messages(self, capsys, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": {
        ...
        self.integration_test(
            updated_config, mysql_engine, expected_results, test_stream
        )
    ...
    @pytest.mark.slow
    def test_relational_data(self, config, mysql_engine):
        ...
        #  in order to also test UPSERTing records to MySQL
        self.integration_test(
            config, mysql_engine, expected_results, test_stream, drop_schema=False
        )
        ...
        self.integration_test(
            config, mysql_engine, expected_results, test_stream, drop_schema=True
        )

    @pytest.mark.slow
    def test_no_primary_keys(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": {"test_no_pk": 3},
            "tables": ["test_no_pk"],
    ...
    def test_duplicate_records(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
    ...
    @pytest.mark.slow
    def test_array_data(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": {"test_carts": 4},
            "tables": ["test_carts"],
    ...
    @pytest.mark.slow
    def test_encoded_string_data(self, config, mysql_engine):
        # The expected results to compare
        expected_results = {
            "state": {
                "test_strings": 11,
    ...
    def integration_test(
        self, config, mysql_engine, expected, stream_file, drop_schema=True
    ):
        try:
            # Create the TargetMySQL and fully run it using the user_location_data
            target = TargetMySQL(config)
            ...
            with mysql_engine.connect() as connection:
                for table in expected["tables"]:
                    # Check that the Table has been created in MySQL
