...
def sqlalchemy_column_type(schema_property):
    ...
    property_maxLength = schema_property["maxLength"] if "maxLength" in schema_property else None

    if "object" in property_type:
        return TEXT()  # OBJECT
    elif "array" in property_type:
        return TEXT()  # ARRAY
    elif "text" in property_type:
        return TEXT()  # ARRAY
        ...
        return Boolean
    elif "string" in property_type and  property_maxLength != None:
        return VARCHAR(property_maxLength) 
    else:
        return TEXT
